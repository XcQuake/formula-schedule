    ...
    <section className="stats">
      <ul className="stats__list">
        <ul className="driver__params driver__params_head">
          <li className="driver__param text__align_center">Pos</li>
          <li className="driver__param">Name</li>
          <li className="driver__param text__align_center">Pts</li>
          <li className="driver__param text__align_center">Wins</li>
          <li className="driver__param">Team</li>
          <li className="driver__param text__align_center">Nationality</li>
        </ul>
